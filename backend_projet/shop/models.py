...
class User(AbstractUser):
    ...
    avatar = models.ImageField(upload_to='avatars/', blank=True, default="avatars/default-avatar.png")
    metiers_hobbies = models.CharField(max_length=255, null=True, blank=True)
    bio = models.TextField(null=True, blank=True)
    image_banniere_profil = models.ImageField(upload_to='bannieres/', blank=True, default="bannieres/default-banner.webp")
